...
public class StreamingSubscriber implements AIGateway.Subscriber {
    ...
    private final Consumer<Message.Payload> onMessagePayloadReady;
    private final Consumer<Map<String, Object>> onStateChanged;

    private StreamingSubscriber(ChatService.StreamObserver streamObserver, Consumer<Message.Payload> onMessagePayloadReady, Consumer<Map<String, Object>> onStateChanged) {
        this.streamObserver = streamObserver;
        this.onMessagePayloadReady = onMessagePayloadReady;
        this.onStateChanged = onStateChanged;
    }

    static StreamingSubscriber create(ChatService.StreamObserver streamObserver, Consumer<Message.Payload> onMessagePayloadReady, Consumer<Map<String, Object>> onStateChanged) {
        return new StreamingSubscriber(streamObserver, onMessagePayloadReady, onStateChanged);
    }

    @Override
    public void onMessagePayloadReady(Message.Payload payload) {
